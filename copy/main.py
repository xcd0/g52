...
# https://github.com/KMKfw/kmk_firmware/blob/master/docs/split_keyboards.md
# https://github.com/KMKfw/kmk_firmware/blob/master/docs/keycodes.md
# KC.MT https://github.com/KMKfw/kmk_firmware/blob/master/docs/modtap.md
...
# 例) KC.LT(1, KC.SPC)  # tapでSPC holdでLayer1に
# 例) KC.TD(KC.A, KC.B) # tapでA double tapでB

# 3x9
keyboard.keymap = [
    [  # QWERTY
        KC.ESC  , KC.Q    , KC.W    , KC.E , KC.R , KC.T    , KC.MHEN , KC.INS  , KC.NO   ,
        KC.NO   , KC.LALT , KC.HENK , KC.Y , KC.U , KC.I    , KC.O    , KC.P    , JP_AT   ,
        CT_TAB  , KC.A    , KC.S    , KC.D , KC.F , KC.G    , KC.SPC  , KC.LSFT , KC.LCTL ,
        KC.HENK , KC.BSPC , KC.ENT  , KC.H , KC.J , KC.K    , KC.L    , KC.SCLN , JP_COLN ,
        KC.LSFT , KC.Z    , KC.X    , KC.C , KC.V , KC.B    , KC.HOME , L1      , L2      ,
        L3      , KC.DEL  , KC.END  , KC.N , KC.M , KC.COMM , KC.DOT  , KC.SLSH , JP_YEN
    ]
    #],
    #[  # L1
    #    # ------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
...
if __name__ == '__main__':
    #print( "row_pins" )
    #print(keyboard.row_pins)
    #print( "col_pins" )
    #print(keyboard.col_pins)
    #print(keyboard.len_cols)
